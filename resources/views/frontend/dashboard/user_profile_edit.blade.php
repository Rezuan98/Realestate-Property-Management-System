...
<form action="{{route('user.profile.update')}}" enctype="multipart/form-data" method="post" class="default-form">
    @csrf
...
<div class="form-group">
    ...
    <img id="showImage" style="width:100px; height:100px;" src="{{ !empty($userData->photo) ? url('upload/user_images/' . $userData->photo) : url('upload/no_image.jpg') }}" alt="">
</div>
