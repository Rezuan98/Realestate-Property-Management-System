                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="amenities_id[]"   class="js-example-basic-multiple form-select"
                                        ...
                                        @foreach ($amenities as $item)
                                            <option value="{{ $item->amenities_name }}" {{ (in_array($item->amenities_name,$property_amenities)) ? 'selected' : ''}}>{{ $item->amenities_name }}
                                            </option>
                                        @endforeach
                        ...
                        <form id="myForm" method="post" action="{{ route('agent.store.new.multiimage')}}" enctype="multipart/form-data">
                            ...
                            <table class="table table-striped">
                                <tbody>
                                    <tr>
                                  <td>
                                    <input type="file" class="form-control" name="multiimage" id="">
                                  </td>
                                  <td>
                                    <input type="submit" class="btn btn-info" id="" value="Add Image">
                                  </td>
